...
public class ImageWindow extends JInternalFrame implements FocusListener, InternalFrameListener {
    ...
    public ImageWindow(ImagePlus imp, ImageCanvas ic) {
        ...
        container.add(ic);
        //container.setComponentZOrder(ic, 1);
        ...
        if (previousWindow!=null) {
            ...
            if (ij!=null && !IJ.isMacintosh()) {
                ...
                if (img!=null)
                  ...
                  try {setFrameIcon(new ImageIcon(img)); } catch (Exception e) {}           
            }
            if (centerOnScreen) {
                GUI.center(this);
    ...
    private void setLocationAndSize(boolean updating) {
        ...
        if (xbase==-1) {
            ...
            Rectangle ijBounds = new Rectangle(100,50,0,0);
            if (IJ.isMacintosh())
                ijBounds.height += 24;
            count = 0;
            xbase = 5;
