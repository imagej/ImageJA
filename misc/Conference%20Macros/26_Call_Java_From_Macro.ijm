...
// number of string arguments, returning a string.
    ...
    if (getVersion>="1.37e") {
        print("Time:", call("java.lang.System.currentTimeMillis")); // same as getTime()
        print("Free memory:", call("ij.IJ.freeMemory"));
        print("Max memory:", parseInt(call("ij.IJ.maxMemory"))/(1024*1024)+"MB");
        print("Alt key down:", call("ij.IJ.altKeyDown"));
        print("Is Macintosh:", call("ij.IJ.isMacintosh"));
