...
// To use numeric keypad shortcuts you need to be running 
// ImageJ 1.33g or later. To override built in shortcuts
// you need to be running ImageJ 1.33i or later.
...
// use the ImageJ or plugin shortcut.
  ...
  macro "Lower case a [a]" {
      print("");
      print("Lower case a (requires 1.33i or later)");
 ...
 macro "One [1]" {
      print("");
      print("One (requires 1.33i or later)");
