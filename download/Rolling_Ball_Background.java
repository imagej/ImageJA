...
*/
public class Rolling_Ball_Background implements ExtendedPlugInFilter, DialogListener {
    ...
    private int pass;
    private int flags = DOES_8G|DOES_16|DOES_RGB|FINAL_PROCESSING|KEEP_PREVIEW|PARALLELIZE_STACKS;
    
    public int setup(String arg, ImagePlus imp) {
        if (arg.equals("final") && imp.getBitDepth()!=16) {
