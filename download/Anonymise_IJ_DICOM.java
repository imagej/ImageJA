...
/** This plugin allows data in the DICOM header revealed by Image > Show Info to be anonymised.
 *
 * The text used to substitute for the patient's name etc. is customisable, as is the choice of tags to be anonymised
*/



public class Anonymise_IJ_DICOM implements PlugInFilter {
	ImagePlus imp;    
	...
	static final String anonTextdefault="Anonymised";
	String header, anonText="";
	
	public int setup(String arg, ImagePlus imp) {
	this.imp = imp;
	IJ.register(Anonymise_IJ_DICOM.class);
	...
	boolean showDialog(){
		GenericDialog gd = new GenericDialog("Anonymise IJ DICOM");
