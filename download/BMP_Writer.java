...
public class BMP_Writer implements PlugInFilter {
    //--- Private constants
    ...
    void writeImage(ImagePlus imp) throws Exception {
        this.imp = imp;
        ...
        if(sd.getFileName()==null) {
            return;
             ...
             imp.startTiming();
             saveBitmap ( sd.getDirectory()+sd.getFileName(), imp.getImage(), imp.getWidth(), imp.getHeight() );
        }
    }
